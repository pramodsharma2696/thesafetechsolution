...
<footer class="main_footer footer_bg">
					...
					<div class="row">
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="web_services footer_widget">
								...
								<ul class="list-unstyled footer_text">
									<li><a class="text-white" href="website-design-company-mumbai.html" target="_blank">Website Designing</a></li>
									<li><a class="text-white" href="web-hosting-company-mumbai.html" target="_blank">Web Hosting</a></li>
									<li><a class="text-white" href="graphic-design-company-mumbai.html" target="_blank">Graphic Design</a></li>
									<li><a class="text-white" href="web-development-company-mumbai.html" target="_blank">Web Development</a></li>
									<li><a class="text-white" href="digital-marketing-company-mumbai.html" target="_blank">Digital Marketing</a></li>
									<li><a class="text-white" href="application-development-company-mumbai.html" target="_blank">App Development</a></li>
									<li><a class="text-white" href="other-services.html" target="_blank">Other Services</a></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-12">
							<div class="footer_contact footer_widget">
								...
								<div class="contact_us">
									...
									<a class="text-white" href="mailto:info@The Safetech Solutions.in">info@The Safetech Solutions.in</a>
								</div>
							</div>
						</div>
	...
	<div class="footer_bottom pt-4 position_rel">
		<div class="shapes_wrapper f_shape_wrapper">
			...
			<img src="{{ asset('')}}assets/images/shapes/leaf-left.webp" alt="" class="left_shape img_shapes">
			<img src="{{ asset('')}}assets/images/shapes/leaf-right.webp" alt="" class="right_shape img_shapes">
			<img src="{{ asset('')}}assets/images/shapes/women.webp" alt="" class="women_shape img_shapes">
			<img src="{{ asset('')}}assets/images/shapes/man.webp" alt="" class="man_shape img_shapes">
			<img src="{{ asset('')}}assets/images/shapes/people.webp" alt="" class="text-center people_shape img_shapes">
		</div>
		<div class="copyright">
			<p class="mb-0 py-2 text-white text-center">© Copyright 2018 <a href="index.html" target="_blank" title="Best Web Development Company In Mumbai" class="font-weight-medium">The Safetech Solutions IT Services</a>. All Rights Reserved.</p>
		</div>
	</div>
</footer>
...
<script src="{{ asset('')}}assets/js/flip_text.js"></script>
<script src="{{ asset('')}}assets/js/mobilemenu.js"></script>
<script src="{{ asset('')}}assets/js/popup_timer.js"></script>
...
<!-- Toastr -->
<script src="{{ asset('')}}assets/js/toastr.min.js" async></script>
...
$(document).ready(function(){
  $(".checkoutbtn").click(function(){
    ...
    xhttp.open("GET.html", "store-checkout2f66.html?p_name="+p_name+"&p_id="+p_id+"&p_amount="+p_amount+"&client_name="+client_name+"&mobile_number="+mobile_number+"&email="+email+"&razorpay_order_id="+razorpay_order_id, true);
    xhttp.send();
